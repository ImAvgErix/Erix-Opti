...
public sealed partial class HardwarePage : Page
{
    ...
    private async void OnExport(object sender, RoutedEventArgs e)
    {
        ...
        sb.AppendLine($"CPU: {h.CpuName} ({h.CpuCores}C/{h.CpuLogicalProcessors}T, {h.CpuMaxClockMhz} MHz, L3 {VM.L3Display})");
        ...
        sb.AppendLine($"Monitors: {h.MonitorCount} | USB: {h.UsbDeviceCount} | Audio: {VM.AudioSummary}");
